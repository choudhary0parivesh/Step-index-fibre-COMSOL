...
%% Model exported on Nov 13 2019, 11:42 by COMSOL 5.4.0.388.
clear all;
...
model.component('comp1').view('view1').axis.set('xmin', -2.193877662648447E-6);
model.component('comp1').view('view1').axis.set('xmax', 1.5193878425634466E-5);
model.component('comp1').view('view1').axis.set('ymin', -6.000000212225132E-7);
model.component('comp1').view('view1').axis.set('ymax', 1.2600000445672777E-5);
